...
import org.jasig.cas.client.boot.configuration.EnableCasClient.ValidationType;
...
public class CasClientConfigurationProperties {
	...
	/**
	 * CAS server login URL E.g. https://example.com/cas/login or
	 * https://cas.example/login. Required.
	 */
	@NonNull
	...
	/**
	 * List of URL patterns protected by CAS single sign out filter.
	 */
	private List<String> singleSignOutUrlPatterns = new ArrayList<>();
	...
	/**
	 * ValidationType the CAS protocol validation type. Defaults to CAS3 if not
	 * explicitly set.
	 */
	...
	public List<String> getSingleSignOutUrlPatterns() {
		return singleSignOutUrlPatterns;
	}
